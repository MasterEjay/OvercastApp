...
public class Thread extends Activity implements CustomWebView.OnBottomReachedListener{
	...
	protected class ThreadParse extends AsyncTask<String, String, String>{
		public void parsePage(String link){
			...
			final Element e = doc.getElementsByClass("span9").get(0);
			...
			try {
				...
				Thread.this.runOnUiThread(new Runnable() {
			...
			Elements buttonEach = null;
			if(pages != null){
				buttonEach = pages.getElementsByClass("btn");
			}
